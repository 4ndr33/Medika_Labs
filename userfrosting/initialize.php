...
$table_tickets = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "tickets", [
    ...
    "allocated_to",
    "assigned_to",
    "allocated_to_provider_admin",
    "user_organisation_id",
    "user_admin_id"
    
]);

$table_tickets_worklog = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "tickets_worklog", [
    "ticket_id",
    "user_id",
    "user_name",
	"time_stamp",
...
$table_offers = new \UserFrosting\DatabaseTable($app->config('db')['db_prefix'] . "offers", [
    "from_id",
    "dest_id",
    "position_id",
    "from_name",
...
$app->hook('includes.css.register', function () use ($app){
	...
	$app->schema->registerCSS("dashboard", "horizontal-bar.css");
	
    // Logged-out CSS
    $app->schema->registerCSS("loggedout", "jumbotron-narrow.css");
    
    $app->schema->registerCSS("common", "image-modal.css");
    $app->schema->registerCSS("common", "running-text.css");
